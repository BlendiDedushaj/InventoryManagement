...
namespace InventoryManagement.Migrations
{
    ...
    [Migration("20230131145134_AddIdentityToPoDetailsTable")]
    partial class AddIdentityToPoDetailsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryManagement.Models.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryManagement.Models.Currency", b =>
                {
                    b.HasOne("InventoryManagement.Models.Currency", "Currencies")
                        .WithMany()
            ...
            modelBuilder.Entity("InventoryManagement.Models.PoHeader", b =>
                {
                    b.HasOne("InventoryManagement.Models.Currency", "BaseCurrency")
                        .WithMany()
                        .HasForeignKey("BaseCurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InventoryManagement.Models.Currency", "POCurrency")
                        .WithMany()
            ...
            modelBuilder.Entity("InventoryManagement.Models.Product", b =>
                {
                    ...
                    b.HasOne("InventoryManagement.Models.ProductProfile", "ProductProfiles")
                        .WithMany()
